...
HD_PWD='C:/Users/AdminPC/Lab1/Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Bound_Flasher.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Bound_Flasher.tcl
