...
HD_PWD='C:/Users/AdminPC/Lab1/Lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Bound_Flasher.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Bound_Flasher.tcl -notrace
